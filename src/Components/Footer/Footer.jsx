  ...
  return (
    <div className='footer'>
      ...
      <div className="footer-top">
        ...
        <div className="footer-top-left">
          ...
          <p>
            ...
            user-friendly web applications using HTML, CSS, JavaScript, and React.js.
            I love writing clean code and creating engaging digital experiences.
          </p>
        </div>
      ...
      <div className='footer-bottom'>
        ...
        <div className="footer-bottom-right">
          <p onClick={() => handleOpen("Terms of Service")}>
            Terms of Service
          </p>

          <p onClick={() => handleOpen("Privacy Policy")}>
            Privacy Policy
          </p>
